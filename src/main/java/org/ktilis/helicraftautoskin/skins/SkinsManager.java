...
public class SkinsManager {
    ...
    private static Skin mineSkinReq(String skinUrl) throws IOException {
        ...
        URL url = new URL(HeliCraftAutoSkin.MineSkinRequestUrl);
    ...
    public static void updateSkin(Player p) {
        String skinURL = HeliCraftAutoSkin.getInstance().getConfig().getString("skins-url").replaceAll("<nick>", p.getDisplayName());
